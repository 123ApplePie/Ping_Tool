<x-admin-layout>
    ...
    <div class="flex pb-8">
        ...
        <div class="flex items-center mt-4 gap-x-3 ml-auto"> 
            <a href=/customers/add" class="flex font-semibold text-lg items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-[#328fff] rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-800 dark:hover:bg-blue-500 dark:bg-blue-600">
